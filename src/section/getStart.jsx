  ...
  return (
    <> 
     ...
     <img 
            ...
            src="/src/assets/images/hero-section-food.png" alt="" />
     </section>
        ...
        <article className="relative w-[80%] md:w-[100%] flex flex-col md:flex-row justify-center items-center">
          ...
          <div className="relative top-[450px] md:top-0 md:left-20 z-50 ">
            <p className="font-raleway-black text-6xl md:w-[500px]">Healthy & Fresh Food For You</p>
            <p className="md:w-[350px] mt-1 text-gray-600">Create for your family, friends, and the community. delicious food is the future.</p> 
            <button
            className="mt-2 mb-2 p-3 px-3 rounded-lg bg-[#fa7a03] font-raleway-bold flex gap-2"
            >Check Menu <img src="/src/assets/icons/check-menu-icon.svg" alt="" /></button>
          ...
          <div className="md:w-[50%]">
            ...
            src="/src/assets/images/hero-section-slide-food-1.png" alt="" />
          </div>

        </article>
        </section>
      
        <section className=" w-full h-[300px] md:w-[25%] md:h-auto bg-white md:bg-[#2c8240]">
